...
export let mascotasPrueba: Mascota[] = [
  ...
  { id:12, nombre:'Lucky', propietario:3, fechaNac:new Date('2010-03-30'), raza:'Cocker', color:'Miel', genero:'macho', tipo:1, fotoUrl:'https://images.ctfassets.net/denf86kkcx7r/5ms5SU4yhexGdkSbnBgwm4/7a268c6cfb7a883fce3452e962a0cb8e/cockerspanielinglessegurosantevet-83' },
